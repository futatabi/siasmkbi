<?php
	...
	$query="select * from ekskul where kode_ekskul='$kode'";
			...
			<div class="modal-body">
				<div class="control-group">
					<form method="post" action="#"> 
						<div class="controls">
							<input class="input-xlarge" type="text" id="form-field-first" name="namaekskul" required="required" maxlength="30" value="<?php echo $namae?>" /> 
							<br>
				...
				<?php
					...
					if(isset($_POST['submitkelas'])){
						...
						$query="update ekskul set nama_ekskul='$namae' where kode_ekskul='$kode'";
						$simpan=mysqli_query($koneksi,$query);

						if($simpan){
							echo "<script type='text/javascript'>alert('berhasil update ekskul')</script>";
