						...
						<div class="login-container">
							<div class="row-fluid">
								...
								<div class="span9 center">
									...
									<h4 class="red"> SMK Bakti Idhata</h4>
								</div>
							</div>
								...
								<div class="position-relative">
									<div id="login-box" class="login-box visible widget-box no-border">
										<div class="widget-header">
											<h5 class="bigger red lighter">Silakan Login Sebagai :</h5>
										...
										<div class="widget-body">
											<div class="widget-main">
												...
												<div class="space-6"></div>
												<form action="admin/cekadmin.php" method="post">
													<fieldset>
														<label>
														...
														<div class="space"></div>
														<div class="clearfix">
															<button class="width-35 pull-right btn btn-small btn-danger" type="submit" value="submit" name="login">
																<i class="icon-key"></i>
																Login
															</button>
														</div>
