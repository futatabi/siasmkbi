<?php
	...
	// $resulttbl=mysqli_query($querytbl);
	...
	$html .='<table>
			...
			<br>';
	$html .='<h3>Capaian Hasil Belajar</h3>
			<br>
			<table cellpadding="5" width="98%">
				...
				<tr>
					<td></td>
					<td class="border" width="100%">Deskripsi :<br>'.$data1[$spiritual].'<br><br></td>
				</tr>
				<tr>
					<th>B.</th>
				...
				<tr>
					<td></td>
					<td class="border" width="100%">Deskripsi :<br>'.$data2[$sikap].'<br><br></td>
				</tr>
				<tr>
					<th>C.</th>
	...
	$html .='<tr><td colspan="10">Muatan Nasional</td></tr>';
	...
	while ($datamn=mysqli_fetch_array($resultmn)){
		...
		if (($datamn['nama_mp']=='Pendidikan Agama Islam')||($datamn['nama_mp']=='Pendidikan Agama Kristen')||($datamn['nama_mp']=='Pendidikan Agama Katholik')||($datamn['nama_mp']=='Pendidikan Agama Hindu')||($datamn['nama_mp']=='Pendidikan Agama Buddha')||($datamn['nama_mp']=='Pendidikan Agama Kong Hu Cu')) {
			...
			$html .='<td>Pendidikan Pancasila dan Kewarganegaraan</td>
					<td align="center">'.$datamn['kkm'].'</td>
					<td align="center">'.$nilaip.'</td>
					<td align="center">'.$prep.'</td>
					<td>'.$datamn[$desp].'</td>
	...
	$html .='<tr><td colspan="10">Muatan Lokal</td></tr>';
	...
	$html .='<tr><td colspan="10">Muatan Peminatan Kejuruan</td></tr>';
	...
	while ($data3=mysqli_fetch_array($result3)) {
		...
		$html .='<tr><td align="center">'.$i.'</td>';
		$html .='<td>'.$data3['nama_ekskul'].'</td>';
		$html .='<td align="center">'.$kne.'</td></tr>';
		$i++;
	}
	$html .='</tr>
		</table>
	...
	if ($data4['tempat']==null) {
		$html .='<tr><td align="center">-</td><td align="center">-</td><td align="center">-</td></tr>';
	}else{
		...
		$html .='<tr><td>'.$data4['tempat'].'</td>';
		$html .='<td>'.$data4['alamat'].'</td>';
		$html .='<td align="center">'.$knp.'</td></tr>';
	}
	$html .='</table>
			<table cellpadding="5">
			<tr>
	...
	if ($row5=mysqli_num_rows($result5)==0) {
		...
		while ($data5=mysqli_fetch_array($result5)) {
			$html .='<tr><td align="center">'.$i.'</td>';
			$html .='<td>'.$data5['prestasi'].'</td>';
			$html .='<td>'.$data5['keterangan'].'</td></tr>';
			$i++;
		}
	}
	$html .='</tr>
	...
	while ($data6=mysqli_fetch_array($result6)) {
		$html .='<tr><td>Sakit</td>';
		$html .='<td align="center">'.$data6['sakit'].' hari</td></tr>';
		$html .='<tr><td>Izin</td>';
		$html .='<td align="center">'.$data6['izin'].' hari</td></tr>';
		$html .='<tr><td>Tanpa Keterangan</td>';
		$html .='<td align="center">'.$data6['alpha'].' hari</td></tr>';
	}
	$html .='</table>
		<table cellpadding="5" width="98%">
			<tr>
			...
			<tr>
				<td></td>
				<td class="border" width="100%"><br>'.$data1['deskripsi'].'<br><br></td>
			</tr>
			<tr>
				<th>I.</th>
		...
		<br>';
	if ($smt==01) {
		$html .='<table style="padding: 20px" cellpadding="5" width="100%">
				<tr>
		...
		$html .='<table style="padding: 20px; margin-top: 30px" cellpadding="10" width="95%">
				<tr>
					<td align="center">
					<br>Wali Kelas<br><br><br><br><br>
					________________
	...
	$dompdf->render();
	$dompdf->stream('Laporan Rapor-'.$nsiswa.'-Kelas '.$kls.' '.$peminatan.'-Semester '.$kodesmt.'.pdf');
?>