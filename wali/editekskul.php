<?php
	...
	$query="select * from ekskul, ekskul_siswa where ekskul.kode_ekskul=ekskul_siswa.kode_ekskul and ekskul_siswa.id='$kode'";
	$result=mysqli_query($koneksi,$query);
	$row=mysqli_fetch_array($result);
	$namae=$row['nama_ekskul'];
	$nilai=$row['nilai_ekskul'];
?>
<!DOCTYPE html>
<html lang="en">
	<head>
		...
		<div class="modal-body">
			<div class="control-group">
				<form method="post" action="#"> 
					<div class="controls">
						...
						<input class="input-mini" type="number" min="0" max="100" step="0.01" name="nilaieks" value="<?php echo $nilai; ?>" />
						<br>
			...
			<?php
				...
				if(isset($_POST['submitkelas'])){
					...
					$query="update ekskul_siswa set kode_ekskul='$namaeks', nilai_ekskul='$nilaieks' where id='$kode'";
