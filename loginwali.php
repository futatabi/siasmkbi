						...
						<div class="login-container">
							<div class="row-fluid">
								...
								<div class="span9 center">
									...
									<h4 class="green"> SMK Bakti Idhata
									</h4>
								</div>
							</div>
								...
								<div class="position-relative">
									<div id="login-box" class="login-box visible widget-box no-border">
										<div class="widget-header">
											<h5 class="bigger green lighter">Silakan Login Sebagai :</h5>
										...
										<div class="widget-body">
											<div class="widget-main">
												...
												<div class="space-6"></div>
												<form action="wali/cekwali.php" method="post">
													<fieldset>
														<label>
															<span class="block input-icon input-icon-right">
																<input type="text" class="span12" placeholder="Username" name="username" required="required" autofocus/>
																<i class="icon-user"></i>
															</span>
														</label>
														<label>
														...
														<div class="space"></div>
														<div class="clearfix">
															<button class="width-35 pull-right btn btn-small btn-success" type="submit" value="submit" name="login">
